...
nix-shell --run "pserve configs/production_http.ini" > /var/log/rhodecode-vcsserver.log &
cd /rhodecode-develop/rhodecode-enterprise-ce 
nix-shell --run "pserve configs/production.ini" > /var/log/rhodecode-enterprise-ce.log &
