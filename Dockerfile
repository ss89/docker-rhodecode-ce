...
RUN mkdir rhodecode-develop && cd rhodecode-develop && hg clone https://code.rhodecode.com/rhodecode-enterprise-ce -u v4.5.0 && hg clone https://code.rhodecode.com/rhodecode-vcsserver -u v4.5.0
